...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_url', (
            ...
            ('percorso_su_disco', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'core', ['URL'])

        # Adding model 'Interrogazione'
        db.create_table(u'core_interrogazione', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('titolo', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('descrizione', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'core', ['Interrogazione'])

        # Adding M2M table for field url on 'Interrogazione'
        db.create_table(u'core_interrogazione_url', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('interrogazione', models.ForeignKey(orm[u'core.interrogazione'], null=False)),
            ('url', models.ForeignKey(orm[u'core.url'], null=False))
        ))
        db.create_unique(u'core_interrogazione_url', ['interrogazione_id', 'url_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'core_interrogazione')
    ...
    models = {
        ...
        u'core.url': {
            ...
            'percorso_su_disco': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'blank': 'True'})
        }
    }
