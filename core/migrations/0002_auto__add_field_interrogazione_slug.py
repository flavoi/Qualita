...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interrogazione.slug'
        db.add_column(u'core_interrogazione', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='int', max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Interrogazione.slug'
        db.delete_column(u'core_interrogazione', 'slug')
