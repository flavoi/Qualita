...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_url', 'percorso_su_disco', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'URL.percorso_su_disco'
        db.alter_column('core_url', 'percorso_su_disco', self.gf('django.db.models.fields.FilePathField')(path='/vagrant/projects/Qualita/media/uploaded/', max_length=100))
